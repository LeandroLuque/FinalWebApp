(function () {
  ...
  describe('Personals Controller Tests', function () {
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _PersonalsService_) {
    ...
    describe('vm.save() as create', function () {
      ...
      beforeEach(function () {
        ...
        samplePersonalPostData = new PersonalsService({
          name: 'Personal Name'
        });

        $scope.vm.personal = samplePersonalPostData;
      });

      it('should send a POST request with the form input values and then locate to new object URL', inject(function (PersonalsService) {
        // Set POST response
        ...
        expect($state.go).toHaveBeenCalledWith('personals.view', {
    ...
    describe('vm.save() as update', function () {
      beforeEach(function () {
        ...
        $scope.vm.personal = mockPersonal;
      });

      it('should update a valid Personal', inject(function (PersonalsService) {
        // Set PUT response
      ...
      it('should set $scope.vm.error if error', inject(function (PersonalsService) {
    ...
    describe('vm.remove()', function () {
      ...
      it('should delete the Personal and redirect to Personals', function () {
        ...
        expect($state.go).toHaveBeenCalledWith('personals.list');
      });

      it('should should not delete the Personal and not redirect', function () {
